        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {proyectos.map((proj) => (
            <div 
              ...
              className="group relative rounded-2xl overflow-hidden glass-panel aspect-[4/3] cursor-pointer ring-1 ring-white/10 hover:ring-red-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(239,68,68,0.15)]"
            >
